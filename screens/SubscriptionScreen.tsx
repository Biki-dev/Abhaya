  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <Text style={styles.sectionTitle}>Abhaya Plus</Text><Text style={styles.featureText}>Unlimited emergency contacts, full route history, enhanced safety history, and guardian sharing.</Text>{renderPlanPackages(plusPackages)}
